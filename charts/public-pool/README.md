...
| backend.env.BITCOIN_RPC_PASSWORD | string | `"hunter1"` |  |
...
| backend.image.tag | string | `"20798ec"` |  |
...
| frontend.image.repository | string | `"sethforprivacy/public-pool"` |  |
| frontend.image.tag | string | `"5ffea44"` |  |
