...
{{- define "public-pool.ingress.supportsIngressClassName" -}}
  {{- or (eq (include "public-pool.ingress.isStable" .) "true") (and (eq (include "public-pool.ingress.apiVersion" .) "networking.k8s.io/v1beta1") (semverCompare ">= 1.18-0" .Capabilities.KubeVersion.Version)) -}}
{{- end -}}
{{/*
